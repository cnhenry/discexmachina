...
public class ControllerInteractionNetwork : NetworkBehaviour {
    ...
    void FixedUpdate() {
        ...
        if ( joint == null && device.GetTouchDown(SteamVR_Controller.ButtonMask.Trigger) ) {
            ...
            if ( closest != null ) {
                ...
                if ( closest is InteractablePhysicalObject ) { // Create joint and attach to it if closest InteractablePhysicalObject is found.
                ...
                } else if ( closest is InteractableTriggerObject ) { // Trigger the closest found if it is a InteractablePhysicalObject.
